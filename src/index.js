...
function generateAffirmation(event) {
  ...
  let context =
    "You are a positive affirmation expert and love to write short yet meaningful affirmations. Your mission is to generate 1 line affirmation in basic HTML format with quotation marks at the beginning and end of the affirmation. No extra spaces. Make sure to follow the user instructions.";
  ...
  affirmationElement.innerHTML = `<div class="blink">⏳ Generating your Daily Affirmation about ${instructionsInput.value}</div>`;
